				 ...
				 <div class="panel-body">
				   <table class="table table-hover">
      				  <thead>
      				  	...
      				  	<tbody>
      				  		<?php $__currentLoopData = $data_toko; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr>
								<td><?php echo e($data->id); ?></td>
								<td><?php echo e($data->nama_toko); ?></td>
								<td><?php echo e($data->alamat_toko); ?></td>
								<td><?php echo e($data->email_toko); ?></td>
								<td>
									<a href="/toko/<?php echo e($data->id); ?>/profile" class="btn btn-success btn-sm">Profile</a>
								    <a href="/toko/<?php echo e($data->id); ?>/delete" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Dihapus ?')">Hapus</a>
								</td>
							</tr>

...
<body>
  ...
  <div id="wrapper">
    <!-- NAVBAR -->
    <?php echo $__env->make('layouts.includes._navbar', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <!-- END NAVBAR -->
    <!-- LEFT SIDEBAR -->
    <?php echo $__env->make('layouts.includes._sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <!-- END LEFT SIDEBAR -->
    <!-- MAIN -->
